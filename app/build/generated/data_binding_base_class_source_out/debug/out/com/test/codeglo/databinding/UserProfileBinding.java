...
public final class UserProfileBinding implements ViewBinding {
  ...
  private UserProfileBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivPoster,
      @NonNull TextView tvAddress, @NonNull TextView tvAlbum, @NonNull TextView tvEmail,
  ...
  public static UserProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserProfileBinding((LinearLayout) rootView, ivPoster, tvAddress, tvAlbum, tvEmail,
          tvName, tvPhone);
    }
