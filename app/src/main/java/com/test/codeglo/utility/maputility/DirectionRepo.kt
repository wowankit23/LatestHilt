...
import com.test.codeglo.utility.Constants.DIRECTION_URL
...
class DirectionRepo(private val key: String) {
    ...
    private fun getDirectionUrl(
        ...
        return "${DIRECTION_URL}origin=${currentLat},${currentLong}&destination=${destinationLat},${destinationLong}&sensor=false&key=${key}"
    }
